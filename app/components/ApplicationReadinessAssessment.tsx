...
const assessmentQuestions: Record<string, AssessmentQuestion[]> = {
  organizational: [
    ...
    },
    {
      ...
      type: "radio",
      question:
        "How much grant application experience does your organization have?",
      options: [
    ...
    },
    {
      ...
      type: "radio",
      question:
        "Do you have dedicated staff to manage grant applications and projects?",
      options: [
        { value: "none", label: "No dedicated staff", score: 0 },
        {
          value: "part-time",
          label: "Part-time or shared responsibility",
          score: 60,
        },
        {
          value: "dedicated",
          label: "Dedicated grant management staff",
          score: 100,
        },
      ],
      weight: 20,
  ...
  technical: [
    {
      ...
      options: [
        ...
        {
          value: "expert",
          label: "Recognized leader in the field",
          score: 100,
        },
      ],
      weight: 30,
    },
    {
      ...
      type: "checkbox",
      question:
        "Do you have established partnerships relevant to this project?",
      options: [
    ...
    },
    {
      ...
      options: [
        {
          value: "none",
          label: "Would need to acquire most resources",
          score: 20,
        },
  ...
  financial: [
    {
      ...
      options: [
        ...
        {
          value: "excellent",
          label: "Excellent financial reserves",
          score: 100,
        },
      ],
      weight: 25,
    },
    {
      ...
      options: [
        ...
        {
          value: "possible",
          label: "Can likely secure matching funds",
          score: 80,
        },
        {
          value: "ready",
          label: "Matching funds readily available",
          score: 100,
        },
      ],
      weight: 30,
    },
    {
      ...
      options: [
        {
          value: "none",
          label: "No experience with federal budgets",
          score: 20,
        },
  ...
  timeline: [
    {
      ...
      options: [
        ...
        {
          value: "significant",
          label: "Significant time investment",
          score: 85,
        },
...
export const ApplicationReadinessAssessment: React.FC<
  ApplicationReadinessAssessmentProps
> = ({ opportunity, onAssessmentComplete }) => {
  ...
  const currentQuestions =
    assessmentQuestions[currentCategory as keyof typeof assessmentQuestions];
  ...
  const calculateAssessment = (): ReadinessAssessment => {
    ...
    Object.entries(assessmentQuestions).forEach(([category, questions]) => {
      ...
      questions.forEach((question) => {
        ...
        if (question.type === "radio") {
          ...
          const requiredSelected = requiredItems.filter((req) =>
            response?.includes(req),
          ).length;
    ...
    if (categoryScores.financial >= 70) {
      ...
      recommendations.push(
        "Ensure financial systems and matching funds are ready",
      );
    }
    ...
    if (categoryScores.regulatory >= 80) {
      ...
      recommendations.push(
        "Complete all required registrations and compliance training",
      );
    }
    ...
    const baseSuccessProbability =
      opportunity.amount && opportunity.amount > 1000000 ? 30 : 45;
    const readinessBonus = (overallScore - 50) * 0.4; // Max 20 point bonus
    const successProbability = Math.max(
      Math.min(baseSuccessProbability + readinessBonus, 90),
      10,
    );
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200">
          <CardHeader>
            ...
            <p className="text-gray-600">
              Based on your responses, here&apos;s your readiness profile for
              this opportunity.
            </p>
          </CardHeader>
        </Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <div
                  className={`text-2xl font-bold ${getScoreColor(assessment.successProbability)}`}
                >
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded-full bg-blue-100 text-blue-800 text-sm flex items-center justify-center font-bold">
                  1
                </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span>
                  Complete all required registrations and documentation
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded-full bg-blue-100 text-blue-800 text-sm flex items-center justify-center font-bold">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>
                  Begin drafting your proposal {assessment.estimatedPrepTime}{" "}
                  before the deadline
                </span>
              </div>
            </div>
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-gray-600">
            Answer these questions to assess your {currentCategory}{" "}
            preparedness.
          </p>
        </CardHeader>
