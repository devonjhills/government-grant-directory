...
export const OPPORTUNITY_TYPE_CONFIGS: Record<
  OpportunityType,
...
> = {
  grant: {
    ...
    displayName: "Grant",
    description:
      "Financial assistance that generally does not require repayment",
    colorScheme: {
...
export function getOpportunityType(opportunity: any): OpportunityType {
  ...
  if (type === "cooperative_agreement" || type === "cooperative agreement")
 ...
 */
export function getOpportunityTypeConfig(
  opportunity: any,
): OpportunityTypeConfig {
 ...
 */
export function formatOpportunityMetrics(
  opportunity: any,
  config: OpportunityTypeConfig,
) {
 ...
 */
export function getTypeSpecificCompetition(
  opportunity: any,
  type: OpportunityType,
) {
  const config = OPPORTUNITY_TYPE_CONFIGS[type];
  ...
  switch (type) {
    ...
    case "grant":
      return {
        competitionDescription:
          "Merit-based selection among qualified applicants",
        successFactors: [
    ...
    case "cooperative_agreement":
      return {
        competitionDescription:
          "Partnership selection with substantial federal involvement",
        successFactors: [
