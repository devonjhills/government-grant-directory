...
export default function HomePageClient({ initialFeaturedGrants, initialError }: HomePageClientProps) {
  const router = useRouter();
  const [featuredGrants, setFeaturedGrants] = useState<Grant[]>(initialFeaturedGrants);
  ...
  const [isLoading, setIsLoading] = useState<boolean>(initialFeaturedGrants.length === 0 && !initialError);
